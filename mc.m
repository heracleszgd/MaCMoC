...
epass  =   4e3          ; % eqs = esteps for equilibrium
mpass  =   4e3          ; % mcs = msteps for statistic
Ts     =   120:-2:2     ; % [80:-2:2] ; % linspace(100,0,10)  ; % Always in a descending order!

para   =   3            ; % (first revise code) Parallel workers (cores), depending on your CPU, spare one for urself.
kb     =   8.617333262145e-5 ; % Boltzmann constant in eV/kelvin. or 1.380649e-23 in Joules/kelvin
% (3*S^2*J1/Kb) / (4*1^2/1) = Tc / 2.269 , this is good for estimating Tc. '3' is for hexagonal
% e.g., (3*((2/2)^2)*1.966e-3)*2.269/(4*8.617333262145e-5)
